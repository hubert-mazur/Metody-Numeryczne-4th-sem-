...
set output "cos2.eps" # nazwa pliku wynikowego
...
plot 'Build/dane2.dat' using 1:2 with lines title "wykres funkcji", 'Build/dane2.dat' using 1:3 with points title "dopasowanie metoda interpolacji"
