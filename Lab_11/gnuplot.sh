...
set output "sygnal_zaburzony_i_odszumiony_k=8_jpg" # nazwa pliku wynikowego
...
set output "sygnal_niezaburzony_i_odszumiony_k=8_jpg" # nazwa pliku wynikowego
...
set output "sygnal_zaburzony_i_odszumiony_k=10_jpg" # nazwa pliku wynikowego
...
set output "sygnal_niezaburzony_i_odszumiony_k=10_jpg" # nazwa pliku wynikowego
...
set output "sygnal_zaburzony_i_odszumiony_k=12_jpg" # nazwa pliku wynikowego
...
set output "sygnal_niezaburzony_i_odszumiony_k=12_jpg" # nazwa pliku wynikowego
...
set output "czesc_rzeczywista_i_urojona_k=8_jpg" # nazwa pliku wynikowego
